...
<div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
    ...
    {/* ...........Left  section.......... */}
    <div>
     {/* <img src={assets.logo} alt='' height="10%" width="10%" cursor-pointer/> */}
     ...
     <ul className='flex flex-col gap-2 text-gray-600'>
        <li>Monday - Friday <span>06:00 AM - 10:00 PM</span></li>
    ...
    <div>
        ...
        <ul className='flex flex-col gap-2 text-gray-600'>
          <li>+91 9991452229</li>
          <li>swastikclinic5888@gmail.com</li>
        </ul>
     </div>
</div>
<div>
...
<hr/>
<p className='py-5 text-sm text-center'>Copyright © 2017 Swastik care</p>
    </div>
  )
}
